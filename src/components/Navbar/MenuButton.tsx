  ...
  return (
    <div className='flex justify-center items-center w-[28px] h-[28px] object-contain'>
        <button className="relative group" onClick={() => setToggle(!toggle) }>
            <div className={`relative flex items-center justify-center rounded-full w-[30px] h-[30px] transform transition-all bg-slate-600 ring-0 ring-gray-300 hover:ring-0 ${!toggle ? 'bg-inherit': 'ring-2 shadow-md'} ring-opacity-30`}>
